		...
		if ( empty( $quick_setup_step ) ) {//First Step / Page installation
			...
			<div class="mp_quick_setup_step mp_quick_setup_step-1">
				<div class="mp_content">
					<img class="mp_quick_setup_image-welcome mp_image" src="<?php echo plugins_url( 'wordpress-ecommerce/includes/admin/ui/images/mp_quick_setup-welcome.png' ); ?>" alt="MarketPress - Quick Setup" height="158" width="158">
